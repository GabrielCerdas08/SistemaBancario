...
public class CuentaBancaria {
    ...
    public void setNumeroCuenta() {
        ...
        for (int i=2001239; i<7821930; i++) {
            list.add(new Integer(i));
        }
        Collections.shuffle(list);
        for (int i=0; i<3; i++) {
          this.numeroCuenta=  list.get(i);
        }
    }

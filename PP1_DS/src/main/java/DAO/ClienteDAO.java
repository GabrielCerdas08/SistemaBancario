...
public class ClienteDAO {
    ...
    private void registrarClienteDAO(String pPrimerApellido, String pSegundoApellido, String pNombre, int pIdentificacion, String pDia, String pMes, String pAnio, int pCodigoCliente){
     try {
        ...
        PreparedStatement st = conexionDAO.connect.prepareStatement("INSERT INTO CLIENTE(identificacion, primerApellido,segundoApellido,nombre,fechaNacimiento,codigoCliente)VALUES (?,?,?,?,?,?)");
    ...
    private void registrarContactoClienteDAO(int pIdentificacion,int pTelefono, String pCorreo){
     try {
        ...
        PreparedStatement st = conexionDAO.connect.prepareStatement("INSERT INTO CLIENTECONTACTO(identificacion,numeroTelefonico,correoElectronico)VALUES (?,?,?)");
        conexionDAO.abrirConexioDAO();
        st.setInt(1,pIdentificacion);
